...
size_t ParseBuf(unsigned char* buf, unsigned bufsize);
void WriteOutfile(char* szFileName, unsigned char* buf, size_t bufsize);
...
void ProcessFile(char* szFileName)
{
	...
	size_t outsize = ParseBuf(_buf, _bufsize);
